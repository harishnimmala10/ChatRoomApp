...
public class EditProfileActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras().getSerializable("existingUser")!=null){
            ...
            else if (existinguserProfile.getGender().toString().equalsIgnoreCase("male")){
               // userGender.setSelection(2);
            ...
            if (male.isChecked() || female.isChecked()){
               ...
               // Log.d("updateuser",editUserFName.getText().toString()+editUserLName.getText().toString()+userGender.getSelectedItem().toString()+profilePicUrl);
                if (profilePicUrl!=null) {
                    updateUserProfile(existinguserProfile.getUid(), editUserFName.getText().toString(), editUserLName.getText().toString(), gender, profilePicUrl.toString());
                }else {
                    updateUserProfile(existinguserProfile.getUid(), editUserFName.getText().toString(), editUserLName.getText().toString(), gender,null);
                }
